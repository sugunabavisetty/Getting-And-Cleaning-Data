...
clnFeatNames <- sapply(features[, 2], function(x) {gsub("[()]", "",x)})
names(dataSet) <- clnFeatNames[meanStdDev]



# combine subject, activity, mean and std data sets to form final data set.
